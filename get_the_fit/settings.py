"""
Django settings for get_the_fit project.
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'gtfcmd@email.co.uk'
else:
...
# Additonal authentication settings
...
WSGI_APPLICATION = 'get_the_fit.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    AWS_STORAGE_BUCKET_NAME = 'get-the-fit-cmd'
